...
<header class='text-white z-[999] relative' class:backdrop-blur-md={page!=='home'}>
  ...
  <div class='flex items-center'>
    ...
    <nav class='hamburger-menu'>
      ...
      <div bind:this="{hamburgerNav}" class='absolute top-[-120vh] left-0 w-screen h-screen bg-asa-red rounded-bl-[300px] rounded-br-[300px] ease-out duration-1000 bg-opacity-95'>
        ...
        <div class='footer-sns mx-auto flex absolute bottom-32 justify-evenly items-center w-[20rem] left-1/2 -translate-x-1/2'>
        ...
        <div class='email absolute w-full overflow-hidden pt-4 bottom-14 left-1/2 -translate-x-1/2 m-auto text-center text-gray-200 mt-80 border-t-[1px] border-t-[#ffffff11]'>
